...
var ColorOrganizer = function (_React$Component) {
  ...
  _createClass(ColorOrganizer, [{
    ...
    value: function render() {
      ...
      // return (
      // <div class="color-organizer-container">
      //   <div className="color-organizer-header">
      //     <p>add form will come here</p>
      //   </div>
      //   <div className="color-organizer-body u-flex--item-table">
      //     <Color color={color}
      //       title={title}
      //       starLimit={starLimit}
...
//# sourceMappingURL=0.d49a54e4dd4a8f68bb33.hot-update.js.map